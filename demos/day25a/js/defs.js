const uni = {
  ...
  moves: {
    ...
    fd: [
      {t: 250, ts: 6, tx: 0.25, sVP: 8},
      {t: 250, ts: 1, tx: 0.5},
      {t: 250, ts: 7, tx: 0.75},
      {t: 250, ts: 0, tx: 1},
    ],
    j2: [
      {t: 600, ts: 2, tx: 0, sVP: 3},
    ...
    f: [
      ...
      {t: 800, ts: 4, tx: 0.5, ty: 0.5, try: 0.4, sZ: 0.6},
      {t: 800, ts: 3, tx: 1, ty: 1, trz: 1.5, try: 0.6, sZ: 0.8},
      {t: 200, ts: 8, tx: 1, ty: 1, trz: 2, try: 1, sZ: 0.5},
      {t: 500, ts: 1, tx: 1, ty: 1, trz: 2, try: 1, sZ: 0, tf: 1},
    ],
    x: [
      {t: 1000, ts: 2, trz: 0, sZ: 0.3},
      {t: 500, ts: 4, ty: 1, trz: -1, sZ: 0.6},
      {t: 500, ts: 3, ty: 3, trz: -1, sZ: 0.8},
